// --------------------------------------------------------------------------------------------------------------------
// <copyright file="basicSemanticSpider.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.evaluators
{
    ...
    public class basicSemanticSpider:spiderEvaluatorSimpleBase
    {
        ...
        public basicSemanticSpider(spiderUnit __parent) : base("BasicSemanticSpider", "Content Semantic analysis of the real home page.", "reportInclude\\testdocs\\basicSemanticSpider.md", __parent, true)
        {
            settings.primaryPageSetSize = 2;
            settings.limitIterations = 2;
            settings.limitTotalLinks = 20;
            settings.limitIterationNewLinks = 10;
        }
