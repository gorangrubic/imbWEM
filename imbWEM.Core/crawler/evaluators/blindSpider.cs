// --------------------------------------------------------------------------------------------------------------------
// <copyright file="blindSpider.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.evaluators
{
    ...
    /// 
    /// </remarks>
    public class blindSpider:spiderEvaluatorSimpleBase
    {
        /// <summary>
        /// Parameterless constructor
        /// </summary>
        public blindSpider(spiderUnit __parent) :base("BlindSpider", "Plain link extraction and ranking mechanism", "reportInclude\\testdocs\\blindSpider.md", __parent, true)
        {
         ...
         //   controlPageRules.Add(new controlPageCrossQ1(this, 10));

           // controlRules.Add(new controlPageLoad(this, 22));
           // controlRules.Add(new controlCrossLinks(this, 10));

            settings.primaryPageSetSize = 12;
            settings.limitIterations = 30;
            settings.limitTotalLinks = 5000;
            settings.limitTotalPageLoad = 100;
