...
namespace imbWEM.Core.crawler.evaluators
{
    ...
    public class domainSemanticSpider: spiderEvaluatorSimpleBase
    {
        ...
        public domainSemanticSpider(spiderUnit __parent) : base("DomainSemanticSpider", "Domain-knowledge and Lexicon guided web analysis.", "reportInclude\\testdocs\\domainSemanticSpider.md", __parent, true)
        {
