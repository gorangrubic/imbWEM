// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SM_LD.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.evaluators.modular
{
    ...
    public class SM_LD : spiderModularEvaluatorBase, ISpiderWithLanguageModule, ISpiderWithDiversityModule
    {



        public SM_LD(spiderUnit __parent)
            : base("SM-LD", "SM crawler with Language and Diversity frontier modules", "sm_ld.md", __parent)
        {
