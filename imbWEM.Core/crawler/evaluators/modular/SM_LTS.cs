// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SM_LTS.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.evaluators.modular
{
    ...
    public class SM_LTS : spiderModularEvaluatorBase, ISpiderWithLanguageModule, ISpiderWithTemplateModule, ISpiderWithStructureModule
    {
        public SM_LTS(spiderUnit __parent)
            : base("SM-LTS", "SM crawler with Language, Template and Structure_rank frontier modules", "sm_lts.md", __parent)
        {
...
//            module_diversity = modules.AddGet(new diversityModule(tt_diversityFactor, pt_diversityFactor, this, termExpansionSteps));
            //modules.Add(new diversityModule(0.5, 0.5, this));
        }
    }
