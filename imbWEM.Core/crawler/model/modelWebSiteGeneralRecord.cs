// --------------------------------------------------------------------------------------------------------------------
// <copyright file="modelWebSiteGeneralRecord.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.model
{
    ...
    public class modelWebSiteGeneralRecord : modelRecordSummaryParentBase<webSiteProfile, crawledPage, modelWebPageGeneralRecord, spiderWeb, modelSpiderSiteRecord>
    {
        ...
        public modelWebSiteGeneralRecord():base("unknown", null) {

        }


        public modelWebSiteGeneralRecord(string __testRunStamp, webSiteProfile __instance) : base(__testRunStamp, __instance)
        {
        }

        public override void AddSideRecord(modelSpiderSiteRecord __sideRecord)
        {
            __sideRecord.wGeneralRecord = this;
