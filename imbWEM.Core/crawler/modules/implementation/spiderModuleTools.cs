// --------------------------------------------------------------------------------------------------------------------
// <copyright file="spiderModuleTools.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.modules.implementation
{
    ...
    public static class spiderModuleTools
    {
        public static string GetInlineDescription(this layerStack layers)
        {
            StringBuilder sb = new StringBuilder();

            sb.AppendLine("Layers [" + layers.Count + "] => links [" + layers.CountAll + "]");
            int c = 0;
            foreach (layerCollection layer in layers)
            {
                sb.AppendLine(c.ToString("D2") + " " + layer.name + " => links [" + layer.Count + "]");
                c++;
            }
            return sb.ToString();
        }
