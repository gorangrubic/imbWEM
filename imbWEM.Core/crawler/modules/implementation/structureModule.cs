// --------------------------------------------------------------------------------------------------------------------
// <copyright file="structureModule.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.modules.implementation
{
    ...
    public class structureModule : spiderLayerModuleBase
    {
        ...
        public override void reportIteration(directAnalyticReporter reporter, modelSpiderSiteRecord wRecord)
        {
            ...
            //layerTargetUrlGraph graphRule = layerActiveRules[0] as layerActiveRules;
        ...
        {
            layers.AddLayer("Primary", "Targets matching the best node (with highest score) or its children");
            layers.AddLayer("Secondary", "Targets matching brand-children of the best node");
            layers.AddLayer("Reserve", "Other targets");

            AddRule(new layerTargetUrlGraph(0, 1, 2, parent));
            if (alternative)
            {
                AddRule(new rankTargetUrlGraph(parent, 100));
            }
