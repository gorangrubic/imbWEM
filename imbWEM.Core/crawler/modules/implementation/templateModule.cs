// --------------------------------------------------------------------------------------------------------------------
// <copyright file="templateModule.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    public class templateModule : spiderLayerModuleBase
    {
        ...
        {
            layers.AddLayer("Navigation", "Targets found in the navigation block");
            layers.AddLayer("Information", "Targets found in a information block");
            layers.AddLayer("Reserve", "The rest of the targets");

            AddRule(new layerBlockRolePRule(nodeBlockSemanticRoleEnum.navigation, 0, parent, -1));// (0, 1, 2, parent));
            AddRule(new layerBlockRolePRule(nodeBlockSemanticRoleEnum.information, 1, parent, 2));
            
            if (alternative)
            {
                AddRule(new rankLinkXPath(parent, 100));
            }
