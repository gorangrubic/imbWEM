// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ruleActiveBase.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.rules.active
{
    ...
    public abstract class ruleActiveBase:spiderEvalRuleForLinkBase, IAppendDataFields, IRuleActiveBase, IRuleForTarget
    {
        ...
        /// <summary>What is current iteration </summary>
        public int iteration { get; protected set; } = new int();


        /// <summary>Reference to current <see cref="modelSpiderSiteRecord"/> instance</summary>
        public modelSpiderSiteRecord wRecord { get; protected set; }

        /// <summary>
        /// Called automatically after <see cref="iteration"/> and <see cref="wRecord"/> were set in <see cref="startIteration(int, modelSpiderSiteRecord)"/>
        /// </summary>
        ...
        /// <summary>
        /// Takes information from a page - called in foreach loop for <see cref="spiderWeb.webPages"/> collection of loaded pages
        /// </summary>
        /// <param name="page">The page.</param>
        public abstract void learn(spiderLink page);

        public void learn(ISpiderElement element) => learn(element as spiderLink);
