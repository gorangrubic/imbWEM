// --------------------------------------------------------------------------------------------------------------------
// <copyright file="controlObjectiveRuleBase.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    public abstract class controlObjectiveRuleBase:controlRuleBaseBase
    {
        ...
        public override spiderEvalRuleSubjectEnum subject
        {
            get
            {
                return spiderEvalRuleSubjectEnum.objectives;
            }
        }

        public abstract spiderObjectiveSolution evaluate(modelSpiderSiteRecord sRecord, params object[] resources);
