// --------------------------------------------------------------------------------------------------------------------
// <copyright file="controlRuleBaseBase.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.rules.control
{
    ...
    public abstract class controlRuleBaseBase : spiderEvalRuleBase
    {
        public override spiderEvalRuleRoleEnum role
        {
            get
            {
                return spiderEvalRuleRoleEnum.control;
            }
        }
        ...
        /// 
        /// </summary>
        public spiderObjectiveType type { get; set; } = spiderObjectiveType.dropOutControl;

        /// <summary>
        /// 
        /// </summary>
        public spiderObjectiveStatus afirmative { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public spiderObjectiveStatus denial { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public spiderObjectiveEnum objective { get; set; }

        /// <summary> </summary>
        public int treshold { get; protected set; } = new int();
