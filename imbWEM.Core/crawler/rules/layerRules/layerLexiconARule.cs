// --------------------------------------------------------------------------------------------------------------------
// <copyright file="layerLexiconARule.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.rules.layerRules
{
    ...
    public class layerLexiconARule : layerDistributionPassiveRuleBase
    {
        public layerLexiconARule(int __layerID, ISpiderEvaluatorBase __parent, int __layer2ID = -1) : base("Lexicon token test", 
            "If the TST found in the Semantic Lexicon it is distributed to the layerID [{0}], otherwise the layer2ID [{1}] is applied", __layerID, __parent, __layer2ID)
        {
            
            description = string.Format(description, layerID, layer2ID);
        }
