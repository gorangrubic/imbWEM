// --------------------------------------------------------------------------------------------------------------------
// <copyright file="pageruleLinkScoreBonus.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    public class pageruleLinkScoreBonus : spiderEvalRuleForPageBase
    {
        /// <summary>
        /// The highest link score in the web
        /// </summary>
        public int linkScoreMax { get; set; } = 1;


        /// <summary>
        /// Initializes a new instance of the <see cref="pageruleLinkScoreBonus"/> class.
        /// </summary>
        /// <param name="__parent">The parent.</param>
        public pageruleLinkScoreBonus(spiderEvaluatorSimpleBase __parent) : base("Link score bonus", "Score bonus for score its discovery link earned, proportional to the highest score in the set.", 10, 0, __parent)
        {
        }
