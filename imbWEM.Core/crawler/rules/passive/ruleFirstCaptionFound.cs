// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ruleFirstCaptionFound.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.rules.passive
{
    ...
    public class ruleFirstCaptionFound : spiderEvalRuleForLinkBase
    {
        /// <summary>
        /// 
        /// </summary>
        public List<string> knownCaptions { get; set; } = new List<string>();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ruleFirstCaptionFound"/> class.
        /// </summary>
        /// <param name="__parent">The parent.</param>
        public ruleFirstCaptionFound(spiderEvaluatorSimpleBase __parent) : base("First caption found", "If the link caption is the first time seen", 2, -1, __parent)
        {
        }
