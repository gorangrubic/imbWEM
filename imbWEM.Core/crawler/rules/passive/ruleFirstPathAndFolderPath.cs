// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ruleFirstPathAndFolderPath.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.rules.passive
{
    ...
    public class ruleFirstPathAndFolderPath : spiderEvalRuleForLinkBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ruleFirstPathAndFolderPath"/> class.
        /// </summary>
        /// <param name="__parent">The parent.</param>
        public ruleFirstPathAndFolderPath(spiderEvaluatorSimpleBase __parent) : base("First path/folder found", "Rewards link with new folder-path, double reward for complete path (including filename, excluding parameters), single penalty", 2, -1, __parent)
        {
        }
