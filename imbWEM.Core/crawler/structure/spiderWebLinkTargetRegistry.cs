// --------------------------------------------------------------------------------------------------------------------
// <copyright file="spiderWebLinkTargetRegistry.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.crawler.structure
{
    ...
    /// <summary>
    /// Registar of unique targets 
    /// </summary>
    /// <seealso cref="IWebRegistries" />
    public class spiderWebLinkTargetRegistry: IWebRegistries
    {
        public int Count()
        {
            return items.Count();
