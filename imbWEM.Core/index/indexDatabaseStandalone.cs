// --------------------------------------------------------------------------------------------------------------------
// <copyright file="indexDatabaseStandalone.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    /// Portable index data
    /// </summary>
    public class indexDatabaseStandalone
    {

        public List<indexDatabaseStandalone> additionalDatabases { get; set; } = new List<indexDatabaseStandalone>();
        ...
        public indexDomainTable domainIndexTable { get; set; }
        public indexPageTable pageIndexTable { get; set; }
