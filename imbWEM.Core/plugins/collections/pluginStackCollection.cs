// --------------------------------------------------------------------------------------------------------------------
// <copyright file="pluginStackCollection.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    {
        public void Add(IPlugInCommonBase plug)
        {
            Add(plug.plugin_group, plug);
        }
        ...
        public int InstallTo(IAPlugInCollectionBase collection, plugInGroupEnum group, bool removeFromStack=true)
        {
            ...
            foreach (IPlugInCommonBase plug in this[group])
            {
                ...
                if (collection.IsEnabled)
                {
                    ...
                    if (removeFromStack) toRemove.Add(plug);
