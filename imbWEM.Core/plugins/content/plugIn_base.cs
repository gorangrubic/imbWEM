// --------------------------------------------------------------------------------------------------------------------
// <copyright file="plugIn_base.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    public abstract class plugIn_base : IPlugInCommonBase
    {
        ...
        public plugInGroupEnum plugin_group { get; internal set; }
        ...
        public abstract void eventDLCFinished<TParent>(TParent __parent, crawlerDomainTask __task, modelSpiderSiteRecord __wRecord);
