// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ISpiderPlugIn.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.plugins.crawler
{
    ...
    public interface ISpiderPlugIn:IPlugInCommonBase<crawlerDomainTaskIterationPhase, ISpiderEvaluatorBase>
    {
        /*
        crawlerDomainTaskIterationPhase[] INSTALL_POINTS { get; }

        /// <summary>
        /// Events the plugin installed --- when new spider instance being constructed
        /// </summary>
        /// <param name="__spider">The spider.</param>
        void eventPluginInstalled(ISpiderEvaluatorBase __spider);
        ...
        void eventDLCInitiated(ISpiderEvaluatorBase __spider, crawlerDomainTask __task, modelSpiderSiteRecord __wRecord);
        ...
        /// <param name="__task">The task.</param>
        /// <param name="__wRecord">The w record.</param>
        void eventDLCFinished(ISpiderEvaluatorBase __spider, crawlerDomainTask __task, modelSpiderSiteRecord __wRecord);
