// --------------------------------------------------------------------------------------------------------------------
// <copyright file="indexPlugInCollection.cs" company="imbVeles" >
//
...
namespace imbWEM.Core.plugins.index
{
    ...
    public class indexPlugInCollection : APlugInCollectionBase<indexMaintenanceStageEnum, experimentSessionEntry>, IAPlugInCollectionBase
    {
        ...
        public void eventDLCInitiated(object __parent, crawlerDomainTask __task, modelSpiderSiteRecord __wRecord)
        {
            ...
            {
                plug.eventDLCInitiated(__parent as experimentSessionEntry, __task, __wRecord); /// aJob, __machine, __tRecord);
            }
        }
        ...
        public indexPlugInCollection(experimentSessionEntry __parent) : base(__parent)
        {
            parent = __parent;
