// --------------------------------------------------------------------------------------------------------------------
// <copyright file="indexPlugIn_base.cs" company="imbVeles" >
//
...
using imbNLP.Data.semanticLexicon.term;
    ...
    public abstract class indexPlugIn_base: plugIn_base, IPlugInCommonBase<indexMaintenanceStageEnum, experimentSessionEntry>
    {
        public plugInGroupEnum plugin_group { get
            {
                return plugInGroupEnum.index;
            }
      ...
      //  public abstract Enum[] INSTALL_POINTS { get; }
        ...
        public abstract void eventDLCInitiated(experimentSessionEntry __spider, crawlerDomainTask __task, modelSpiderSiteRecord __wRecord);
       ...
       // public abstract void eventCrawlJobFinished(analyticJob aJob, crawlerDomainTaskMachine __machine, modelSpiderTestRecord __tRecord);
        public abstract void eventUniversal<indexDomain, indexPage>(indexMaintenanceStageEnum stage, experimentSessionEntry __parent, indexDomain __domain, indexPage __page);
        public abstract void eventIteration(experimentSessionEntry __session, crawlerDomainTask __task, modelSpiderSiteRecord __wRecord);
